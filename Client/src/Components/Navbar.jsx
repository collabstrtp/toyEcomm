    ...
    <div className="bg-white shadow-xl py-0 px-6 rounded-full flex justify-between items-center mx-auto max-w-7xl mt-4 relative overflow-hidden">
      ...
      <div className="hidden md:flex items-center space-x-4">
        ...
        {isAuthenticated ? (
          ...
          <button className="bg-orange-500 text-white px-5 py-2 rounded-full font-medium shadow-md hover:bg-orange-600">
            Login/Signup
          </button>
        )}
      </div>
      ...
      >
        ...
        <ul className="flex flex-col items-center space-y-4 p-4 text-gray-800 font-medium">
          {isAuthenticated ? (
            ...
            <a href="/login" onClick={() => setIsOpen(false)} className="hover:text-orange-500">
              Log In
            </a>
          )}
          <NavLinkComponent to="/" onClick={() => setIsOpen(false)}>Home</NavLinkComponent>
          <NavLinkComponent to="/about" onClick={() => setIsOpen(false)}>About Us</NavLinkComponent>
          <NavLinkComponent to="/services" onClick={() => setIsOpen(false)}>Products</NavLinkComponent>
          <button onClick={handleBooking} className="text-left hover:text-orange-500">Cart</button>
          <NavLinkComponent to="/contact-us" onClick={() => setIsOpen(false)}>Wishlist</NavLinkComponent>

        ...
        {blogs?.length === 0 ? (
          ...
          <div>
            {blogs?.map((post) => (
              <div
                key={post._id}
                className="ring-1 ring-gray-300 p-6 lg:p-12 mb-4 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow"
              >
                <div className="flex lg:flex-row flex-col-reverse justify-between">
                  ...
                  <div>
                    <img
                      className="h-[30vh] lg:h-[50vh] w-full object-contain bg-gray-100 rounded border border-gray-300"
                ...
                <div>
                  <p className="text-black font-anta text-[18px] pt-3">
                    {post.content}
                  </p>
                  {/* Comments Section */}
                  <div className="mt-4">
